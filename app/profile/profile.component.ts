...
export class ProfileComponent implements OnInit {
  ...
  deleteProfile(){
    alertify.confirm("Are you sure about the delete this profile ? (Please don't)",
      () =>{
        let id=0;
        this.http.get<any>(this.path).subscribe(res=>{
          let customer:any=[]
          ...
          customer = res.find((a:Customers)=>{
            if(a.userName===localStorage.getItem("customer")){
              ...
              this.customerService.deleteCustomer(id).subscribe(res=>{
                alertify.message("Profile deleted successfully (Unfortunately :( )")
      ...
      function(){
        alertify.message('Oh God thanks');
      });
  }
